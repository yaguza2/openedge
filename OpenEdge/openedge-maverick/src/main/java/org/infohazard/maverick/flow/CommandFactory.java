...
/**
 * Factory for creating Command objects based on some preloaded context
 * (such as global views) and an XML command node.
 *
...
class CommandFactory
{
	...
	{
		Controller ctl = this.controllerFactory.createController(commandNode.getChild(TAG_CONTROLLER));
    ...
    /**
     * Set view registry.
     * @param viewRegistry viewRegistry to set.
     */
     ...
     * @param controllerFactory controllerFactory to set.
     */
