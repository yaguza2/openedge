/*
s * $Id: ThrowawayBean2.java,v 1.3 2003/02/19 22:50:47 lhoriman Exp $
...
/**
 * <p>
 * ThrowawayBean2 is a throwaway controller which populates its bean properties using the
 * Apache BeanUtils. Note that unless you set the model yourself, the default will be
 * "this".
 * </p>
 * 
 * <p>
 * This is the typical use case of html form processing; the controller itself will have
 * setters and getters for the various fields. See the FriendBook sample for several
 * examples of this idiom.
 * </p>
 * 
 * <p>
 * It's certainly not necessary to use the controller-as-model pattern. You can set
