...
public final class PasswordHelper implements Serializable
{
	...
	/**
	 * Turn a byte array into a char array containing a printable hex representation of
	 * the bytes. Each byte in the source array contributes a pair of hex digits to the
	 * output array.
	 * 
	 * @param src
	 *            the source array
	...
	/**
	 * Zero the contents of the specified array. Typically used to erase temporary storage
	 * that has held plaintext passwords so that we don't leave them lying around in
	 * memory.
	 * 
	 * @param pwd
	 *            the array to zero
	...
	/**
	 * Perform MD5 hashing on the supplied password and return a char array containing the
	 * encrypted password as a printable string. The hash is computed on the low 8 bits of
	 * each character.
	 * 
	 * @param pwd
	 *            The password to encrypt
	 * @return a character array containing a 32 character long hex encoded MD5 hash of
	 *         the password
	 */
