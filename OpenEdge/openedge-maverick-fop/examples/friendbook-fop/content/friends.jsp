<%--
	...
	$Source: /cvsroot/mav/maverick/examples/friendbook-jsp/content/friends.jsp,v $
--%>
...
<p><a href="friendsPdf.m">Click here</a> to see this list as a pdf generated by a custom fo document.</p>
<p><a href="friendsPdf2.m">Click here</a> to see this html run through a stylesheet to convert it to fo, and then run through fop to generate a pdf. (Note: until I find a better html_to_fop stylesheet, the results are terrible.)</p>
