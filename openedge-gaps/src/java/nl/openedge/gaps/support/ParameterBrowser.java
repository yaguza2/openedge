...
public final class ParameterBrowser {
    ...
    /**
     * Voer query uit en retourneer de resulterende positie/ het resultaat
     * (zelfde als getCurrentPosition()).
     * @param query navigatie query
     * @return huidige positie/ resultaat (zelfde als getCurrentPosition())
     * @throws GPathInterpreterException indien de query niet kan worden
     *             uitgevoerd
     */
    ...
    /**
     * Voer query uit en retourneer de resulterende positie/ het resultaat
     * zonder deze positie/ resultaat current te maken.
     * @param query navigatie query
    ...
    /**
     * Evalueer query met het gegeven translatie object en retourneer het
     * resultaat.
