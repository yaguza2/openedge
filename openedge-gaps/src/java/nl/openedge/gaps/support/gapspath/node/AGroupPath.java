...
public final class AGroupPath extends PPath {
    ...
    public AGroupPath(PStructGroup _structGroup_, PParamGroup _paramGroup_, POptions _options_) {
    ...
    public String toString() {
        return "" + toString(_structGroup_) + toString(_paramGroup_) + toString(_options_);
    }
