...
public class Parser {
    ...
    public Parser(Lexer lexer) {
        ...
        if (actionTable == null) {
            try {
                DataInputStream s = new DataInputStream(new BufferedInputStream(Parser.class
                        .getResourceAsStream("parser.dat")));
    ...
    private void push(int numstate, ArrayList listNode) throws ParserException, LexerException,
            IOException {
    ...
    ArrayList new3() {
        ...
        PPath ppathNode1;
        {
            ...
            ppathNode1 = new AGroupPath(pstructgroupNode2, pparamgroupNode3, poptionsNode4);
        }
        nodeList.add(ppathNode1);
        return nodeList;
    }
    ...
    ArrayList new4() {
        ...
        PPath ppathNode1;
        {
            ...
            ppathNode1 = new AParamPath(pstructgroupNode2, pparamgroupNode3, pparamNode4, null);
        }
        nodeList.add(ppathNode1);
        return nodeList;
    }
    ...
    ArrayList new16() {
        ...
        PParam pparamNode1;
        {
            ...
            pparamNode1 = new AParam(tslashNode2, tidNode3, parrayselectNode4, pattributeNode5);
        }
        nodeList.add(pparamNode1);
        return nodeList;
    }
    ...
    ArrayList new24() {
        ...
        POptionsPart poptionspartNode1;
        {
            ...
            poptionspartNode1 = new AOptionsPart(tidNode2, teqNode3, tquoteNode4, tidNode5,
                    tquoteNode6);
        }
    ...
    /*
     * { {{-1, ERROR, 0}, {6, SHIFT, 1}, {9, SHIFT, 2}, }, {{-1, REDUCE, 6}, {9,
     * SHIFT, 5}, }, {{-1, REDUCE, 7}, {6, SHIFT, 6}, }, {{-1, ERROR, 3}, {12,
     * ACCEPT, -1}, }, {{-1, REDUCE, 0}, {4, SHIFT, 9}, {8, SHIFT, 10}, }, {{-1,
     * REDUCE, 8}, {6, SHIFT, 6}, }, {{-1, ERROR, 6}, {9, SHIFT, 14}, }, {{-1,
     * REDUCE, 25}, }, {{-1, REDUCE, 9}, {6, SHIFT, 6}, }, {{-1, ERROR, 9}, {9,
     * SHIFT, 16}, }, {{-1, ERROR, 10}, {9, SHIFT, 19}, }, {{-1, REDUCE, 1}, {4,
     * SHIFT, 9}, {6, SHIFT, 20}, }, {{-1, REDUCE, 2}, }, {{-1, REDUCE, 10}, {6,
     * SHIFT, 6}, }, {{-1, REDUCE, 11}, }, {{-1, REDUCE, 26}, }, {{-1, ERROR,
     * 16}, {10, SHIFT, 23}, }, {{-1, ERROR, 17}, {5, SHIFT, 24}, }, {{-1,
     * REDUCE, 20}, {0, SHIFT, 25}, {1, SHIFT, 26}, }, {{-1, REDUCE, 12}, },
     * {{-1, ERROR, 20}, {9, SHIFT, 29}, }, {{-1, REDUCE, 4}, {4, SHIFT, 9}, },
     * {{-1, REDUCE, 3}, }, {{-1, ERROR, 23}, {11, SHIFT, 31}, }, {{-1, REDUCE,
     * 19}, }, {{-1, ERROR, 25}, {9, SHIFT, 16}, }, {{-1, ERROR, 26}, {9, SHIFT,
     * 16}, }, {{-1, REDUCE, 27}, }, {{-1, REDUCE, 21}, {0, SHIFT, 25}, {1,
     * SHIFT, 26}, }, {{-1, REDUCE, 13}, {2, SHIFT, 35}, {7, SHIFT, 36}, },
     * {{-1, REDUCE, 5}, }, {{-1, ERROR, 31}, {9, SHIFT, 39}, }, {{-1, REDUCE,
     * 22}, }, {{-1, REDUCE, 23}, }, {{-1, REDUCE, 28}, }, {{-1, ERROR, 35},
     * {11, SHIFT, 40}, }, {{-1, ERROR, 36}, {9, SHIFT, 41}, }, {{-1, REDUCE,
     * 14}, {7, SHIFT, 36}, }, {{-1, REDUCE, 15}, }, {{-1, ERROR, 39}, {11,
     * SHIFT, 43}, }, {{-1, ERROR, 40}, {9, SHIFT, 44}, }, {{-1, REDUCE, 18}, },
     * {{-1, REDUCE, 16}, }, {{-1, REDUCE, 24}, }, {{-1, ERROR, 44}, {11, SHIFT,
     * 45}, }, {{-1, ERROR, 45}, {3, SHIFT, 46}, }, {{-1, REDUCE, 17}, }, };
     */
    private static int[][][] gotoTable;

    /*
     * { {{-1, 3}, }, {{-1, 4}, }, {{-1, 7}, {8, 15}, {13, 15}, }, {{-1, 11}, },
     * {{-1, 21}, }, {{-1, 37}, }, {{-1, 38}, {37, 42}, }, {{-1, 12}, {11, 22},
     * {21, 30}, }, {{-1, 17}, }, {{-1, 27}, {28, 34}, }, {{-1, 18}, {25, 32},
     * {26, 33}, }, {{-1, 8}, {5, 13}, }, {{-1, 28}, }, };
     */
    private static String[] errorMessages;

    /*
     * { "expecting: '/', id", "expecting: l brace, colon, id, EOF", "expecting:
     * l brace, '/', colon, EOF", "expecting: EOF", "expecting: l brace, colon,
     * EOF", "expecting: id", "expecting: l brace, '/', EOF", "expecting: eq",
     * "expecting: r brace", "expecting: 'and', 'or', r brace", "expecting: l
     * brace, EOF", "expecting: '''", "expecting: l bracket, l brace, at, EOF",
     * "expecting: l brace, at, EOF", "expecting: r bracket", };
     */
    private static int[] errors;
    /*
     * { 0, 1, 2, 3, 4, 2, 5, 2, 2, 5, 5, 6, 3, 2, 2, 2, 7, 8, 9, 6, 5, 10, 3,
     * 11, 3, 5, 5, 9, 9, 12, 3, 5, 9, 9, 9, 11, 5, 13, 10, 11, 5, 10, 10, 9,
     * 11, 14, 13, };
     */
}