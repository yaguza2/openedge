...
/**
 * Utility class voor het eenvoudig kunnen aanmaken van - mogelijk - complexe
 * parameter structuren. <br/>
 * <p>
 * De buildXxx methoden creeeren nieuwe instanties van de parameters zonder deze
 * te registreren, de createXxx methoden creeeren EN registreren de parameters.
 * </p>
 */
public class ParameterBuilder {
    ...
    /**
     * Creeer een {@link StringParameter}, en een bijbehorende
     * {@link ParameterValue}met de gegeven string waarde, het id en de versie
     * dat de property is van deze builder. <br>
     * Deze functie registreert de parameter direct; gebruik deze functie om
     * direct een persistente, voor berekeningen beschikbare parameter te maken,
     * of gebruik de methode buildString om een 'speelinstantie' te maken.
     * @param localId het lokale id
     * @param value de waarde als een string (leeg of null indien er geen value
     *            object dient te worden gecreeerd)
     ...
     */
    public StringParameter createString(String localId, String value) throws RegistryException,
     ...
     * {@link ParameterValue}met de gegeven string waarde, het id en de versie
     * dat de property is van deze builder. <br>
     * Deze functie registreert de parameter niet; gebruik deze functie 'om te
     * spelen' met parameters, of gebruik methode createString van deze builder
     * voor create en registratie van de parameter.
     * @param localId het lokale id
     * @param value de waarde als een string (leeg of null indien er geen value
     *            object dient te worden gecreeerd)
     * @return een nieuwe parameter instantie
     ...
     *             parameter(s) te construeren
     */
    protected StringParameter buildString(String localId, String value) throws InputException,
     ...
     * {@link NumericParameterValue}met de gegeven numerieke waarde, het id en
     * de versie dat de property is van deze builder. <br>
     * Deze functie registreert de parameter direct; gebruik deze functie om
     * direct een persistente, voor berekeningen beschikbare parameter te maken,
     * of gebruik de methode buildNumeric om een 'speelinstantie' te maken.
     * @param localId het lokale id
     * @param value de waarde als een string (leeg of null indien er geen value
     *            object dient te worden gecreeerd)
     * @return een nieuwe parameter instantie
     ...
     *             parameter(s) te construeren
     */
    public NumericParameter createNumeric(String localId, String value) throws RegistryException,
            SaveException, InputException, ParameterBuilderException {
     ...
     * de versie dat de property is van deze builder. <br>
     * Deze functie registreert de parameter niet; gebruik deze functie 'om te
     * spelen' met parameters, of gebruik methode createNumeric van deze builder
     * voor create en registratie van de parameter.
     * @param localId het lokale id
     * @param value de waarde als een string (leeg of null indien er geen value
     *            object dient te worden gecreeerd)
     ...
     *             parameter(s) te construeren
     */
    protected NumericParameter buildNumeric(String localId, String value) throws InputException,
            ParameterBuilderException {
    ...
    public NestedParameter createNumericRow(String localId, String[] ids, String[] values)
            throws RegistryException, SaveException, InputException, ParameterBuilderException {
    ...
    /**
     * Lees bestand in van inputstream en converteer naar een array van nested
     * parameters ([][] dus).
     ...
     *             parameter(s) te construeren
     */
    protected NestedParameter[] buildNumericData(
            InputStream is, int startcol, int startrij,
            boolean rijIdIsCol1, String tokens)
        ...
        try {
            ...
            while ((str = line.readLine()) != null) {
                ...
                if ((!str.startsWith("#")) && (!"".equals(str))) {
                    NestedParameter parameter = readRow(
                            str, tokens, startcol, rijIdIsCol1, rij);
        ...
        return (NestedParameter[]) nestParas.toArray(new NestedParameter[nestParas.size()]);
    }
     ...
     *             parameter(s) te construeren
     */
    protected NestedParameter readRow(
            String line, String tokens, int startcol,
            boolean rijIdIsCol1, int rij)
            throws SaveException, InputException, ParameterBuilderException {
        ...
        NestedParameter parameter = createNumericRow(
                rijNaam.toString(), ids, values);
     ...
     *             parameter(s) te construeren
     */
    protected NestedParameter[] buildNumericData(InputStream is)
            throws SaveException, InputException, ParameterBuilderException {
    ...
    /**
     * Lees bestand in van inputstream en converteer naar een array van nested
     * data en registreerd deze parameters.
     * @param is inputstream
     * @param startcol eerste kolom waar de parameters beginnen
     * @param startrij eerste rij waar de parameterrij begint
     * @param rijIdIsCol1 het rij-id staat in de eerste kolom.
     ...
     *             parameter(s) te construeren
     */
    public NestedParameter[] createNumericData(InputStream is, int startcol, int startrij,
            boolean rijIdIsCol1, String tokens) throws RegistryException, SaveException,
            InputException, ParameterBuilderException {

        NestedParameter[] param = buildNumericData(is, startcol, startrij, rijIdIsCol1, tokens);
     ...
     * {@link PercentageParameterValue}met de gegeven percentage waarde, het id
     * en de versie dat de property is van deze builder. <br>
     * Deze functie registreert de parameter direct; gebruik deze functie om
     * direct een persistente, voor berekeningen beschikbare parameter te maken,
     * of gebruik de methode buildPercentage om een 'speelinstantie' te maken.
     * @param localId het lokale id
     * @param value de waarde als een string (leeg of null indien er geen value
     *            object dient te worden gecreeerd)
     * @return een nieuwe parameter instantie
    ...
    /**
     * Creeer een {@link PercentageParameter}, en een bijbehorende
     * {@link PercentageParameterValue}met de gegeven numerieke waarde, het id
     * en de versie dat de property is van deze builder. <br>
     * Deze functie registreert de parameter niet; gebruik deze functie 'om te
     * spelen' met parameters, of gebruik methode createPercentage van deze
     * builder voor create en registratie van de parameter.
     * @param localId het lokale id
     * @param value de waarde als een string (leeg of null indien er geen value
     *            object dient te worden gecreeerd)
     * @return een nieuwe parameter instantie
     ...
     *             parameter(s) te construeren
     */
    protected PercentageParameter buildPercentage(String localId, String value) throws InputException,
            ParameterBuilderException {
    ...
    /**
     * Creeer een {@link BooleanParameter}, en een bijbehorende
     * {@link ParameterValue}met de gegeven waarde, het id en de versie dat de
     ...
     *             parameter(s) te construeren
     */
    public BooleanParameter createBoolean(String localId, String value) throws RegistryException,
            SaveException, InputException, ParameterBuilderException {
     ...
     *             parameter(s) te construeren
     */
    protected BooleanParameter buildBoolean(String localId, String value) throws InputException,
            ParameterBuilderException {
    ...
    /**
     * Creeer een {@link DateParameter}, en een bijbehorende
     * {@link ParameterValue}met de gegeven waarde, het id en de versie dat de
     * property is van deze builder, en registreer de parameter.
     * @param localId het lokale id
     * @param value de waarde als een string (leeg of null indien er geen value
     ...
     *             parameter(s) te construeren
     */
    public DateParameter createDate(String localId, String value) throws RegistryException,
            SaveException, InputException, ParameterBuilderException {
     ...
     *             parameter(s) te construeren
     */
    protected DateParameter buildDate(String localId, String value) throws InputException,
            ParameterBuilderException {
    ...
    /**
     * Creeer een {@link FixedSetParameter}, en een bijbehorende
     * {@link ParameterValue}met de gegeven waarde, het id, de set toegestane
     * waarden, en de versie dat de property is van deze builder, en registreer
     * de parameter.
     * @param localId het lokale id
     * @param value de waarde als een string (leeg of null indien er geen value
     *            object dient te worden gecreeerd)
    ...
    public FixedSetParameter createFixedSet(String localId, String value,
            ParameterInput[] inputSet, FixedSetInputConverter converter) throws RegistryException,
            SaveException, InputException, ParameterBuilderException {
     ...
     * Creeer een {@link FixedSetParameter}, en een bijbehorende
     * {@link ParameterValue}met de gegeven waarde, het id, de set toegestane
     * waarden, en de versie dat de property is van deze builder.
     ...
     *             parameter(s) te construeren
     */
    protected FixedSetParameter buildFixedSet(String id, String value, ParameterInput[] inputSet,
            FixedSetInputConverter converter) throws InputException, ParameterBuilderException {

        checkIdNotNull(id);
        Parameter param = prepareParameter(new FixedSetParameter(inputSet, converter), id, value);
    ...
    protected void checkIdNotNull(String id) throws ParameterBuilderException {
        if (id == null) { throw new ParameterBuilderException("null invoer niet toegstaan"); }
    }

    /**
     * Doe wat bouw werk voor de parameter zoals het zetten van het id en de
     * value.
    ...
    protected void prepareParameterProperties(Parameter param, String localId)
        ...
        if(topParam != null) { // mogelijk ooit mooier oplossen...
    ...
    /**
     * Bepaal versie adv ofwel de gezette versie of, indien deze null is, de
     * huidige versie van de huidige structuurgroep.
     * @return de versie
     */
     ...
     * @param name lokale naam van de groep, wordt gebruikt bij id generatie
     * @param description de omschrijving
     * @param navigateTo of de builder de nieuwe groep direct op de huidige
     *            dient te zetten (volgende groepen worden dan dus aan deze
     *            nieuw gemaakte toegevoegd)
     * @return een nieuwe groep
     * @throws ParameterBuilderException bij build fouten
     * @throws RegistryException bij onverwachte registry problemen
     * @throws SaveException als de parameter niet kan worden opgeslagen
     */
    public StructuralGroup createStructuralGroup(String name, String description, boolean navigateTo)
            throws ParameterBuilderException, RegistryException, SaveException {
     ...
     * @throws ParameterBuilderException bij build fouten
     */
    protected StructuralGroup buildStructuralGroup(
            String name, String description, boolean navigateTo)
            throws ParameterBuilderException {
    ...
    /**
     * Maakt een groep. Koppelt aan parent, en koppelt de parameters indien deze
     * zijn gegeven. Slaat de groep op in de registry.
     * @param name lokale naam van de groep, wordt gebruikt bij id generatie
     ...
     * Maakt een groep. Koppelt aan parent, en koppelt de parameters indien deze
     * zijn gegeven. Slaat de groep op in de registry.
     * @param extendsFrom de parametergroep waarvan de nieuwe groep dient te
     *            overerven
     * @param name lokale naam van de groep, wordt gebruikt bij id generatie
     * @param description de omschrijving van de groep
     * @return een instantie van {@link StructuralGroup}
     ...
     * @throws ParameterBuilderException indien id null is
     */
    public ParameterGroup createParameterGroup(String name, String description, boolean navigateTo)
            throws ParameterBuilderException {
     ...
     * @throws ParameterBuilderException indien id null is
     */
    protected ParameterGroup buildParameterGroup(
            ParameterGroup extendsFrom, String name,
            String description) throws ParameterBuilderException {
    ...
    protected ParameterGroup buildParameterGroup(
            ParameterGroup extendsFrom, String name,
            String description, boolean navigateTo)
            throws ParameterBuilderException {
    ...
    private void checkParentOfParameterGroup(StructuralGroup parent)
        ...
        if (parent == null) { throw new ParameterBuilderException("parent dient gegeven te zijn "
    ...
    /**
     * Zet de parameterGroup; hiermee wordt direct de structural group op die
     * van de parent gezet.
    ...
    private void checkGroupNotNull(Group group) {
        if (group == null) { throw new IllegalArgumentException("groep moet gegeven zijn"); }
    }

    /**
     * Navigeer naar een groep (bijvoorbeeld /groep/subgroep), en zet deze groep
     * op de huidige. Dit kan worden gebruikt in plaats van zelf browsen/ zoeken
     * en aanroepen setXxGroup met dat resultaat.
     * @param query query naar groep
     * @throws ParameterBuilderException bij parse fouten of indien het
     *             navigatie resultaat geen groep is
     */
