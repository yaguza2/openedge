...
/**
 * Registry voor de beschikbare functie types. Deze registry helpt ons de beheersinterface
 * generiek te kunnen opzetten.
 */
public final class FunctionRegistry
{
	 ...
	 */
	private static final FunctionRegistryDelegate DEFAULT_DELEGATE =
		new DefaultFunctionRegistryDelegate();
	 ...
	 */
	public static Function getFunction(String id) throws NotFoundException,
			RegistryException
	{
	 ...
	 *             heeft kunnen uitvoeren vanwege een onbekende/ generieke fout
	 */
	public static void saveFunction(Function function) throws SaveException,
			RegistryException
	{
