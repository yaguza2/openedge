...
/**
 * Text display of the AST, with (optionally) color output. To print the AST we
 * do a reverse depth first traversal. We do this because it is easier to know
 * which element is the last child in any node. This makes it easier to do nice
 * indenting.
