...
public class Parser {
    ...
    /*
     * { {{-1, ERROR, 0}, {0, SHIFT, 1}, {2, SHIFT, 2}, {3, SHIFT, 3}, {9,
     * SHIFT, 4}, {10, SHIFT, 5}, {11, SHIFT, 6}, }, {{-1, ERROR, 1}, {0, SHIFT,
     * 1}, {2, SHIFT, 2}, {3, SHIFT, 3}, {9, SHIFT, 4}, {10, SHIFT, 5}, {11,
     * SHIFT, 6}, }, {{-1, ERROR, 2}, {0, SHIFT, 1}, {9, SHIFT, 4}, {10, SHIFT,
     * 5}, {11, SHIFT, 6}, }, {{-1, ERROR, 3}, {0, SHIFT, 1}, {9, SHIFT, 4},
     * {10, SHIFT, 5}, {11, SHIFT, 6}, }, {{-1, REDUCE, 9}, }, {{-1, REDUCE,
     * 10}, }, {{-1, ERROR, 6}, {0, SHIFT, 14}, }, {{-1, ERROR, 7}, {12, ACCEPT,
     * -1}, }, {{-1, REDUCE, 0}, {2, SHIFT, 15}, {3, SHIFT, 16}, }, {{-1,
     * REDUCE, 5}, {4, SHIFT, 17}, {5, SHIFT, 18}, }, {{-1, REDUCE, 8}, }, {{-1,
     * ERROR, 11}, {1, SHIFT, 19}, {2, SHIFT, 15}, {3, SHIFT, 16}, }, {{-1,
     * REDUCE, 1}, {4, SHIFT, 17}, {5, SHIFT, 18}, }, {{-1, REDUCE, 2}, {4,
     * SHIFT, 17}, {5, SHIFT, 18}, }, {{-1, ERROR, 14}, {0, SHIFT, 1}, {2,
     * SHIFT, 2}, {3, SHIFT, 3}, {9, SHIFT, 4}, {10, SHIFT, 5}, {11, SHIFT, 6}, },
     * {{-1, ERROR, 15}, {0, SHIFT, 1}, {9, SHIFT, 4}, {10, SHIFT, 5}, {11,
     * SHIFT, 6}, }, {{-1, ERROR, 16}, {0, SHIFT, 1}, {9, SHIFT, 4}, {10, SHIFT,
     * 5}, {11, SHIFT, 6}, }, {{-1, ERROR, 17}, {0, SHIFT, 1}, {9, SHIFT, 4},
     * {10, SHIFT, 5}, {11, SHIFT, 6}, }, {{-1, ERROR, 18}, {0, SHIFT, 1}, {9,
     * SHIFT, 4}, {10, SHIFT, 5}, {11, SHIFT, 6}, }, {{-1, REDUCE, 12}, }, {{-1,
     * REDUCE, 13}, {2, SHIFT, 15}, {3, SHIFT, 16}, {6, SHIFT, 26}, }, {{-1,
     * ERROR, 21}, {1, SHIFT, 29}, }, {{-1, REDUCE, 3}, {4, SHIFT, 17}, {5,
     * SHIFT, 18}, }, {{-1, REDUCE, 4}, {4, SHIFT, 17}, {5, SHIFT, 18}, }, {{-1,
     * REDUCE, 6}, }, {{-1, REDUCE, 7}, }, {{-1, ERROR, 26}, {0, SHIFT, 1}, {2,
     * SHIFT, 2}, {3, SHIFT, 3}, {9, SHIFT, 4}, {10, SHIFT, 5}, {11, SHIFT, 6}, },
     * {{-1, REDUCE, 16}, }, {{-1, REDUCE, 14}, {6, SHIFT, 26}, }, {{-1, REDUCE,
     * 11}, }, {{-1, REDUCE, 15}, {2, SHIFT, 15}, {3, SHIFT, 16}, }, {{-1,
     * REDUCE, 17}, }, };
     */
    private static int[][][] gotoTable;

    /*
     * { {{-1, 7}, }, {{-1, 8}, {1, 11}, {14, 20}, {26, 30}, }, {{-1, 9}, {2,
     * 12}, {3, 13}, {15, 22}, {16, 23}, }, {{-1, 10}, {17, 24}, {18, 25}, },
     * {{-1, 21}, }, {{-1, 27}, {28, 31}, }, {{-1, 28}, }, };
     */
    private static String[] errorMessages;

    /*
     * { "expecting: '(', '+', '-', number, id, funcid", "expecting: '(',
     * number, id, funcid", "expecting: ')', '+', '-', '*', '/', ',', EOF",
     * "expecting: '('", "expecting: EOF", "expecting: '+', '-', EOF",
     * "expecting: ')', '+', '-'", "expecting: ')', '+', '-', ','", "expecting:
     * ')'", "expecting: ')', ','", };
     */
    private static int[] errors;
    /*
     * { 0, 0, 1, 1, 2, 2, 3, 4, 5, 2, 2, 6, 2, 2, 0, 1, 1, 1, 1, 2, 7, 8, 2, 2,
     * 2, 2, 0, 9, 9, 2, 7, 9, };
     */
}