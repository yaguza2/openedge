...
/**
 * Hulpklasse voor het uitvoeren van berekeningen die als strings worden
 * aangeboden.
 */
public final class BerekeningInterpreter {
    ...
    /**
     * Evalueer de gegeven berekenings-expressie met de gegeven context (mag
     * null zijn) en geef het resultaat terug.
     ...
     */
    public static Start parse(String expression)
