...
public class Lexer
{
			...
			else
			{
				if (accept_state != -1)
				{
					switch (accept_token)
					{
						...
						case 11:
						{
							Token token = new11(getText(accept_length), start_line + 1,
									start_pos + 1);
							pushBack(accept_length);
							pos = accept_pos;
							line = accept_line;
	...
	/*
	 * { { // INITIAL {{9, 9, 1}, {10, 10, 2}, {13, 13, 3}, {32, 32, 4}, {39, 39, 5}, {40,
	 * 40, 6}, {41, 41, 7}, {42, 42, 8}, {43, 43, 9}, {44, 44, 10}, {45, 45, 11}, {46, 46,
	 * 12}, {47, 47, 13}, {48, 57, 14}, {58, 58, 15}, {61, 61, 16}, {64, 64, 17}, {65, 90,
	 * 18}, {91, 91, 19}, {93, 93, 20}, {95, 95, 21}, {97, 122, 22}, {123, 123, 23}, {125,
	 * 125, 24}, }, {{9, 32, -2}, }, {{9, 32, -2}, }, {{9, 9, 1}, {10, 10, 25}, {13, 32,
	 * -2}, }, {{9, 32, -2}, }, {{39, 39, 26}, {46, 46, 27}, {47, 47, 28}, {48, 57, 29},
	 * {58, 58, 30}, {61, 61, 31}, {64, 64, 32}, {65, 90, 33}, {91, 91, 34}, {93, 93, 35},
	 * {95, 95, 36}, {97, 122, 37}, }, {}, {}, {}, {}, {}, {}, {{39, 122, -7}, }, {{39,
	 * 122, -7}, }, {{46, 46, 38}, {48, 57, 14}, }, {{39, 39, 39}, {46, 46, 40}, {47, 47,
	 * 41}, {48, 57, 29}, {58, 58, 42}, {61, 61, 43}, {64, 64, 44}, {65, 90, 45}, {91, 91,
	 * 46}, {93, 93, 47}, {95, 95, 48}, {97, 122, 49}, }, {{39, 122, -7}, }, {{39, 122,
	 * -7}, }, {{39, 122, -7}, }, {{39, 122, -7}, }, {{39, 122, -7}, }, {{39, 122, -7}, },
	 * {{39, 122, -7}, }, {}, {}, {{9, 32, -2}, }, {{39, 122, -7}, }, {{39, 122, -7}, },
	 * {{39, 122, -7}, }, {{39, 122, -7}, }, {{39, 122, -7}, }, {{39, 122, -7}, }, {{39,
	 * 122, -7}, }, {{39, 122, -7}, }, {{39, 122, -7}, }, {{39, 122, -7}, }, {{39, 122,
	 * -7}, }, {{39, 122, -7}, }, {{48, 57, 50}, }, {{39, 39, 51}, {46, 46, 52}, {47, 47,
	 * 53}, {48, 57, 54}, {58, 58, 55}, {61, 61, 56}, {64, 64, 57}, {65, 90, 58}, {91, 91,
	 * 59}, {93, 93, 60}, {95, 95, 61}, {97, 122, 62}, }, {{39, 122, -41}, }, {{39, 122,
	 * -41}, }, {{39, 122, -41}, }, {{39, 122, -41}, }, {{39, 122, -41}, }, {{39, 122,
	 * -41}, }, {{39, 122, -41}, }, {{39, 122, -41}, }, {{39, 122, -41}, }, {{39, 122,
	 * -41}, }, {{48, 57, 50}, }, {{39, 122, -41}, }, {{39, 122, -41}, }, {{39, 122, -41}, },
	 * {{39, 122, -41}, }, {{39, 122, -41}, }, {{39, 122, -41}, }, {{39, 122, -41}, },
	 * {{39, 122, -41}, }, {{39, 122, -41}, }, {{39, 122, -41}, }, {{39, 122, -41}, },
	 * {{39, 122, -41}, }, } };
	 */
	...
	/*
	 * { // INITIAL {-1, 9, 9, 9, 9, 12, 0, 1, 4, 2, 6, 3, 12, 5, 10, 12, 12, 12, 12, 12,
	 * 12, 12, 12, 7, 8, 9, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, -1, 11, 11,
	 * 11, 11, 11, 11, 11, 11, 11, 11, 11, 10, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11,
	 * 11, }, };
	 */
