...
public interface FunctionRegistryDelegate {
    ...
    /**
     * Geef de functie die is geregistreerd met het gegeven id voor de huidige
     * versie.
    ...
    /**
     * Geef de functie die is geregistreerd met het gegeven id voor de gegeven
     * versie.
     * @param id het id van de functie
     ...
     *             generieke fout
     */
    Function getFunction(String id, Version version) throws NotFoundException, RegistryException;

    /**
     * Sla de gegeven functie op in - evt persistente - store. LET OP: het
     ...
     * meegegeven instantie zullen geen effect hebben op de opgeslagen functie.
