...
/**
 * Basis controller voor het project. Alle controls in dit project dienen van deze base
 * class te overerven, zodat een aantal standaard elementen kunnen worden ondersteund.
 */
public abstract class AbstractBaseCtrl extends FormBeanCtrl
{
	...
	/**
	 * Initialiseert de base control. Deze methode is final gemaakt om af te dwingen dat
	 * deze methode ALTIJD wordt aangeroepen (anders zijn de overervende controls
	 * verantwoordelijk voor aanroepen super.init(controllerNode). Controls die zich
	 * willen laten initialiseren kunnen init2(controllerNode gebruiken, die na het
	 * uitvoeren van deze init wordt opgeroepen.
	 * <p />
	 * LET OP: probeer vooral niet super.initControl() aan te roepen vanuit init2; je
	...
	/**
	 * Deze init is beschikbaar voor classes die overerven van AbstractBaseCtrl Aangezien
	 * dit een no-op is, hoeven overervende classes niet de super aan te roepen. LET OP:
	 * probeer vooral niet super.init() aan te roepen; je krijgt dan een <b>stackoverflow
	 * </b> error.
	 * @param controllerNode de XML node van Maverick configuratie
	 * @throws ConfigException als er tijdens het configureren iets fout gaat.
	 */
	...
	/**
	 * Bepaal de message bundle key voor een conversie fout voor het gegeven type en veld
	 * met de gegeven naam. Override van de FormBeanCtrl functie
