...
/**
 * Deze servlet wordt gebruikt voor initialisatie; start deze bij voorkeur als
 * eerste op. Zorgt voor initialiseren van de converters en openedge libs, en
 * kijkt of - indien we met een lokale versie werken - de database dient te
 * worden gecreeerd.
 */
...
//        boolean inTestMode = Boolean.valueOf(config.getInitParameter("in-test-mode"))
//                .booleanValue();
//        if (inTestMode) {
