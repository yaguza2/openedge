...
/**
 * Een StructuralGroup wordt gebruikt om de hierarchie van groepen vast te
 * leggen. Bijvoorbeeld: groepen die producten representeren en een groep voor
 * algemene, productonafhankelijke parameters.
 */
public class StructuralGroup extends Group {
    ...
    /**
     * Zet parent; zet direct properties parentId en parentLocalId, en voegt
     * deze instantie toe als child aan de parent.
     * @param parent parent.
     */
    ...
    public StructuralGroup[] getStructuralChilds() {
        ...
        String[] ids = (String[])structuralChildIds.toArray(
                new String[structuralChildIds.size()]);
    ...
    /**
     * Geeft child van type StructuralGroup met het gegeven id indien deze
     * bestaat.
    ...
    public StructuralGroup getStructuralChild(String localChildId) {
        ...
        if(id == null) {
            throw new RegistryException(
                    localChildId + " is niet geregistreerd als parametergroep van "
    ...
    public ParameterGroup[] getParameterChilds() {
        ...
        String[] ids = (String[])parameterChildIds.toArray(
                new String[parameterChildIds.size()]);
    ...
    /**
     * Geeft child van type ParameterGroup met het gegeven id indien deze
     * bestaat.
