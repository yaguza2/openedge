...
/**
 * Een ParameterGroup wordt gebruikt om parameters te groeperen. De groep houdt
 * alleen de alleen de parameter id's bij, en weet hoe de daadwerkelijke
 * instanties zijn op te halen. De parent is altijd een StructuralGroup.
 */
public class ParameterGroup extends Group {
    ...
    /**
     * Eventuele super; als deze is ingevuld, overerft deze groep van de super
     * groep.
     */
    ...
    public void addParameter(Parameter parameter) {
        ...
        if(id == null) {
            throw new RegistryException("kan parameter " + parameter
                    + " niet toevoegen; geen id gegeven");
        }
     ...
     * @return superGroup de supergroep of null indien deze groep niet van een
    ...
    public ParameterGroup getSuperGroup() {
        ...
        if(superGroupId != null) {
            try {
                superGroup = ParameterRegistry.getParameterGroup(superGroupId, getVersion());
            }catch (NotFoundException e) {
                throw new RegistryException(e);
            }
        }
     ...
     * @param superGroup superGroup de supergroep of null indien deze groep niet
     *            van een andere groep overerft
     */
