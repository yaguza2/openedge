...
/**
 * Parameter die een rij (met kolommen) representeert; dit is dus een nesting
 * van parameters.
 */
public final class NestedParameter extends Parameter implements Externalizable {

    /**
     * Tokens die de kolommen van elkaar scheiden bij input in de vorm van een
     * enkele string.
     */
    ...
    /**
     * Geeft de parameter die met de gegeven naam (localId van de parameter) is
     * genest.
