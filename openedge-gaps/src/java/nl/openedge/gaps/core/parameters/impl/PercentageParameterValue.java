...
public final class PercentageParameterValue extends ParameterValue {
    ...
    /**
     * Geeft de waarde als percentage; als de waarde bijvoorbeeld 50,5% is,
     * retourneert deze methode 50.5d.
    ...
    /**
     * Geeft de waarde als factor; als de waarde bijvoorbeeld 50,5% is,
     * retourneert deze methode 0.505d.
     * @return de waarde als percentage
     */
