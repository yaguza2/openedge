...
/**
 * Classes die dit interface implementeren kunnen gebruikt worden voor
 * conversies bij {@link FixedSetParameter}s; door deze constructie kunnen we
 * FixedSetParameter hergebruiken voor sets van verschillende types.
 */
public interface FixedSetInputConverter {
     ...
     * @throws ConversionException indien de invoer niet kan worden
     *             geconverteerd
     */
