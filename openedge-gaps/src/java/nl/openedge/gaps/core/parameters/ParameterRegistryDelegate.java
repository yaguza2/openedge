...
/**
 * Interface voor ondersteuning van strategy pattern voor
 * {@link ParameterRegistry}.<br>
 * <p>
 * <b>LET OP: het interne contract is dat een id uniek gemaakt moet worden over
 * meerdere versie heen. Voor clients dient deze vertaling transparant te zijn.
 * Bijvoorbeeld: stel de versie == 22-12-2005, het id == 'mijnparam', het
 * interne id kan dan zijn '22122005|mijnparam'. </b>
 * </p>
 */
public interface ParameterRegistryDelegate {
    ...
    /**
     * Geef de parameter die is geregistreerd met het gegeven id voor de huidige
     * versie.
    ...
    /**
     * Geef de parameter die is geregistreerd met het gegeven id voor de gegeven
     * versie.
     * @param id het id van de parameter
     ...
     *             generieke fout
     */
    Parameter getParameter(String id, Version version) throws NotFoundException, RegistryException;

    /**
     * Sla de gegeven parameter op in - evt persistente - store. LET OP: het
     * contract is dat er direct een kopie wordt gemaakt, en dat deze kopie
     ...
     *             generieke fout
     */
    void saveParameter(Parameter parameter) throws SaveException, RegistryException;
     ...
     */
    StructuralGroup getStructuralGroup(String groupId, Version version) throws RegistryException,
            NotFoundException;
     ...
     * @throws NotFoundException indien de parameter niet kan worden gevonden
     */
    StructuralGroup getStructuralGroup(String groupId) throws RegistryException, NotFoundException;
     ...
     * @throws NotFoundException indien de parameter niet kan worden gevonden
     */
    ParameterGroup getParameterGroup(String groupId, Version version) throws RegistryException,
            NotFoundException;
     ...
     * @throws NotFoundException indien de parameter niet kan worden gevonden
     */
    ParameterGroup getParameterGroup(String groupId) throws RegistryException, NotFoundException;

    /**
     * Sla de gegeven structuur groep op in - evt persistente - store. LET OP:
     * het contract is dat er direct een kopie wordt gemaakt, en dat deze kopie
     * wordt opgeslagen ipv de gegeven referentie. Maw de snapshot van het
     * object zoals de wordt aangeboden wordt bewaard, en evt bewerkingen op de
     * meegegeven instantie zullen geen effect hebben op de opgeslagen groep.
     * @param group de groep die dient te worden opgeslagen
     * @throws RegistryException bij onverwachte registry fouten
     */
    void saveGroup(StructuralGroup group) throws RegistryException;

    /**
     * Sla de gegeven parameter groep op in - evt persistente - store. LET OP:
     * het contract is dat er direct een kopie wordt gemaakt, en dat deze kopie
     * wordt opgeslagen ipv de gegeven referentie. Maw de snapshot van het
     * object zoals de wordt aangeboden wordt bewaard, en evt bewerkingen op de
     * meegegeven instantie zullen geen effect hebben op de opgeslagen groep.
     ...
     * @throws RegistryException bij onverwachte registry fouten
     */
    void saveGroup(ParameterGroup group) throws RegistryException;
     ...
     * @throws NotFoundException indien de parameter niet kan worden gevonden
     */
    void removeGroup(StructuralGroup group) throws NotFoundException, RegistryException;
