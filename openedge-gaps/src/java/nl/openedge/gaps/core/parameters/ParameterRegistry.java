 ...
 * door static methodes, de toegang makkelijker/ efficienter maakt.
 */
public final class ParameterRegistry
{
	...
	/**
	 * Geef de parameter die is geregistreerd met het gegeven id en de gegeven versie.
	 * @param id het id van de parameter
	...
	/**
	 * Sla de gegeven structuurgroep op in - evt persistente - store. LET OP: het contract
	 * is dat er direct een kopie wordt gemaakt, en dat deze kopie wordt opgeslagen ipv de
	...
	/**
	 * Sla de gegeven parametergroep op in - evt persistente - store. LET OP: het contract
	 * is dat er direct een kopie wordt gemaakt, en dat deze kopie wordt opgeslagen ipv de
	 * gegeven referentie. Maw de snapshot van het object zoals de wordt aangeboden wordt
	 * bewaard, en evt bewerkingen op de meegegeven instantie zullen geen effect hebben op
	 * de opgeslagen parametergroep.
	...
	/**
	 * Geeft delegate; indien een delegate expliciet is gezet wordt deze gegeven, anders
	 * de default instantie.
	 * @return the delegate.
