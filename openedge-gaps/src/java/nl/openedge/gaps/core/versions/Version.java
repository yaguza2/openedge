...
/**
 * Een versie kan worden gekoppeld aan modellen, parameters etc. Het actief zijn
 * van een versie hangt af van:
 * <ul>
 * <li>de ingangsdatum</li>
 * <li>de status</li>
 * Een versie is actief als het de meest recente in het verleden liggende datum
 * heeft van de beschikbare versies, EN deze versie een status heeft die
 * aangeeft dat de versie actief is gemaakt.
 * </ul>
 */
