...
/**
 * De versieregistry houdt versies bij, weet wat de huidige versie is van
 * entiteiten en is in staat om een nieuwe versies aan te maken.
 */
public interface VersionRegistryDelegate {

    /**
     * Geeft de huidige versie voor de enteit met het gegeven id.
     * @param entity de entiteit waarvoor de versie geldt
     * 	of null voor de versie van root
     ...
     * @param entity de node vanaf waar de nieuwe versie geldig is of null
     * 		voor de root structuurgroep
