...
/**
 * De versieregistry houdt versies bij, weet wat de huidige versie is en is in staat om
 * een nieuwe versie aan te maken.
 */
public final class VersionRegistry
{
	 ...
	 * @param entity de groep node vanaf waar de nieuwe versie geldig is of null voor de
	 *            root
	 * @return de nieuwe versie met een niet-actieve status
	 */
	public static Version createVersion(Date ingangsDatum, String name, Entity entity)
	{
	 ...
	 * verwijderd indien de versie nog niet actief is. TODO ALS verwijderen wordt
	 * toegestaan, dienen ook alle samenhangende groepen en parameters te worden
	 * verwijdered
