...
public final class EntityUtil {
    ...
    /** voor toevoegen leesbare timestamp aan ids. */
    private static SimpleDateFormat dateFormat = new SimpleDateFormat("ddMMyy:HH:mm:ss:SSS");
    ...
    /**
     * Maak een nieuw id voor de gegeven entiteit. NOTE: zorg dat de benodigde
     * properties (localId etc) zijn gezet voordat deze functie wordt gebruikt
    ...
    public static String createId(Entity entity) {
        ...
        if (entity.getLocalId() == null) {
            throw new IllegalArgumentException(
                "entiteit dient een naam te hebben");
        }
