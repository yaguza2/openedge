...
public class BasicSwingComponents extends javax.swing.JFrame
{
    ...
    private javax.swing.JPanel getJFrameContentPane()
    {
        if (ivjJFrameContentPane == null)
        {
            ...
            getJFrameContentPane().add(getJCheckBox1(),
                    getJCheckBox1().getName());
            getJFrameContentPane().add(getJRadioButton1(),
                    getJRadioButton1().getName());
            ...
            getJFrameContentPane().add(getJPasswordField1(),
