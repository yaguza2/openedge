/*
 * Project: levob-allureplan-modellen
...
public class ParameterStreamTest extends TestCase {
    ...
    public void testSterfteTafels() throws RegistryException, SaveException, InputException, ParameterBuilderException, GPathInterpreterException {
        Object result = null;
        pb = new ParameterBuilder();
        sg = pb.createStructuralGroup("SterfteTafels", "StarefteTafels voor berekening van koopsommen/lijfrentes");
