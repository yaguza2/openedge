/*
 * $Id: OnderhoudVersionRegistryDelegate.java,v 1.1 2004/08/12 00:10:50 hillenius
 * Exp $ $Revision$ $Date$
 * ================================================================================
...
/**
 * Deze delegate maakt het mogelijk om geldige groepen op te halen
 * waarvan de geldigheidsdatum in de toekomst ligt en is aangemaakt 
 * voor het parameteronderhoudsprogramma.
 * Het is een kopie van de DefaultVersionRegistryDelegate met 1
 * aanpassing in de methode getCurrent.
 * @see nl.openedge.gaps.core.versions.impl.DefaultVersionRegistryDelegate
 */
public final class OnderhoudVersionRegistryDelegate implements VersionRegistryDelegate
{
	...
	/** Log. */
	private static Log log = LogFactory.getLog(OnderhoudVersionRegistryDelegate.class);
	 ...
	 */
	public OnderhoudVersionRegistryDelegate()
	{
