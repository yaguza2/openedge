...
/**
 * Een kopie van de standaard delegate met het verschil dat de nethode getCurrent 
 * geen fout geeft indien deze niet wordt gevonden maar null teruggeeeft.
 * De afhandeling vindt plaats in het onderhoudsprogramma. 
 */
public final class NieuwVersionRegistryDelegate implements VersionRegistryDelegate
{
	...
	/** Log. */
	private static Log log = LogFactory.getLog(NieuwVersionRegistryDelegate.class);
	 ...
	 */
	public NieuwVersionRegistryDelegate()
	{
