...
/**
 * Registry voor parameters die de daadwerkelijke persistency stategie verbergt,
 * en die, door static methodes, de toegang makkelijker/ efficienter maakt.
 */
public final class ParameterRegistry {
     ...
     *             indien de registry een gevraagde actie niet naar behoren
     ...
     * 
     * @param clazz
     *            het type waarvan het prototype dient te worden gegeven
     * @return een werkkopie van de parameter
     * @throws RegistryException
     *             indien de registry een gevraagde actie niet naar behoren
     *             heeft kunnen uitvoeren vanwege een onbekende/ generieke fout
     */
    public static Parameter getParameterPrototype(Class clazz)
            throws RegistryException {
     ...
     * 
     * @param id
     *            het id van de parameter
     * @return de gevonden parameter; kan worden gebruikt als werkkopie
     * @throws NotFoundException
     *             indien de parameter niet kan worden gevonden
     * @throws RegistryException
     *             indien de registry een gevraagde actie niet naar behoren
     *             heeft kunnen uitvoeren vanwege een onbekende/ generieke fout
     */
    public static Parameter getParameter(String id) throws NotFoundException,
            RegistryException {
     ...
     *             heeft kunnen uitvoeren vanwege een onbekende/ generieke fout
     */
    public static Parameter getParameter(String id, Version version)
     ...
     * 
     * @param parameter
     *            de te bewaren parameter
     * @throws SaveException
     *             indien er zich een fout voordoet bij het opslaan
     * @throws RegistryException
     *             indien de registry een gevraagde actie niet naar behoren
     *             heeft kunnen uitvoeren vanwege een onbekende/ generieke fout
     */
    public static void saveParameter(Parameter parameter) throws SaveException,
            RegistryException {
     ...
     * 
     * @param parameter
     *            de te verwijderen parameter
     * @throws SaveException
     *             indien de parameter niet kan worden verwijderd.
     */
     ...
     * @throws RegistryException
     *             bij onverwachte registry fouten
     */
     ...
     *             indien de parameter niet kan worden gevonden
     */
    public static StructuralGroup getStructuralGroup(String groupId,
            Version version) throws RegistryException, NotFoundException {
     ...
     *             indien de parameter niet kan worden gevonden
     */
    public static ParameterGroup getParameterGroup(String groupId,
            Version version) throws RegistryException, NotFoundException {
     ...
     * 
     * @param group
     *            de structuurgroep die dient te worden opgeslagen
     * @throws RegistryException
     *             bij onverwachte registry fouten
     */
    ...
    /**
     * Creeer een kopie van de gegeven groep (of root indien group null is) en
     * alle groepen en parameters die er onder hangen voor de gegeven versie.
     * 
     * @param entity
     *            de entiteit vanaf waar de nieuwe versie geldt
     * @param version
     *            de nieuwe versie
     * @throws RegistryException
     ...
     * 
     * @param group
     *            de parametergroep die dient te worden opgeslagen
     * @throws RegistryException
     *             bij onverwachte registry fouten
     */
     ...
     * 
     * @param group
     *            de te verwijderen structuur groep
     * @throws RegistryException
     *             bij onverwachte registry fouten
     * @throws NotFoundException
     *             indien de parameter niet kan worden gevonden
     ...
     * 
     * @param group de te verwijderen parametergroep
     * @throws RegistryException
     * @throws NotFoundException
     */
    public static void removeParameterGroup(ParameterGroup group)
            throws RegistryException, NotFoundException {
        getDelegate().removeParameterGroup(group);
    }
