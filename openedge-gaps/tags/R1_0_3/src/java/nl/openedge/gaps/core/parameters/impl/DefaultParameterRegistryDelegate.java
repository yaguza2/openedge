 ...
 * geregistreerd bij de {@link nl.openedge.gaps.core.parameters.ParameterRegistry}.
 */
public class DefaultParameterRegistryDelegate implements ParameterRegistryDelegate
{
			...
			RegistryException
	{
		...
		if (id != null)
		{
			try
			{
				...
				if (param == null)
				{
					throw new NotFoundException("Parameter met id "
							+ id + ", versie " + version + " niet gevonden");
				}
			}
			...
			NotFoundException
	{
		try
		{
			...
			if (group == null)
			{
				throw new NotFoundException("Groep met id "
						+ groupId + ", versie " + version + " niet gevonden");
			}
			else
			{
				return group;
	 ...
	 */
	public void saveGroup(StructuralGroup group)
	 ...
	 */
	public void saveGroup(ParameterGroup group)
		throws RegistryException
	{
		try
		{
	...
	/**
	 * @see nl.openedge.gaps.core.parameters.ParameterRegistryDelegate#createVersion(Entity,
	 *      nl.openedge.gaps.core.versions.Version)
	 */
	public void createVersion(Entity entity, Version version) throws RegistryException
	{
		...
		if (workEntity == null)
		{
			workEntity = (StructuralGroup) getRootGroup().clone();
		}
		clone = (Entity) workEntity.clone();
		clone.setVersion(version);
		if (log.isDebugEnabled())
		{
			log.debug("kopieer " + workEntity.getId() + " voor nieuwe versie " + version);
		}
		...
		createVersionForChilds(workEntity, version);
	}
	 ...
	 */
	private void createVersionForChilds(Entity parent, Version version)
			throws RegistryException
	{
	 ...
	 * @throws RegistryException bij onverwachte registry fouten
	 */
	private void createVersionForStructuralGroups(StructuralGroup[] groups,
			Version version) throws RegistryException
	{
	 ...
	 * @throws RegistryException bij onverwachte registry fouten
	 */
	private void createVersionForParameterGroups(ParameterGroup[] groups, Version version)
			throws RegistryException
	{
	 ...
	 * @param version de versie
	 */
	private void createVersionForParameterGroup(ParameterGroup group, Version version)
	{
	 ...
	 * @throws RegistryException bij onverwachte registry fouten
	 */
	private void createVersionForParameters(Parameter[] params, Version version)
			throws RegistryException
	{
	...
	/**
	 * @see nl.openedge.gaps.core.parameters.ParameterRegistryDelegate#removeGroup(nl.openedge.gaps.core.groups.StructuralGroup)
	 */
	public void removeGroup(StructuralGroup group)
