 ...
 */
public class HSQLNestedParamPerformanceTester extends AbstractPerformanceTester
{
	 ...
	 * Construct.
	 */
	public HSQLNestedParamPerformanceTester()
	{
		super();
	}
	...
	public static void main(String[] args)
	{
		...
		AbstractPerformanceTester tester = new HSQLNestedParamPerformanceTester();
		try
		{
