...
#
# Host: localhost   Database: oeaccess_test
# --------------------------------------------------------
...
#
# Dumping data for table 'oeaccess_group'
#
...
DROP TABLE IF EXISTS oeaccess_role;
...
#
# Dumping data for table 'oeaccess_role'
#
...
#
# Dumping data for table 'oeaccess_user'
#
...
#
# Dumping data for table 'oeaccess_user_group'
#
...
DROP TABLE IF EXISTS oeaccess_user_role;
...
#
# Dumping data for table 'oeaccess_user_role'
#
