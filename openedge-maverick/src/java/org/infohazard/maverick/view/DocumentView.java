 ...
 * </p>
 * <p>
 * A DocumentView is a {@link View} that sets up a "model" object in request
 ...
 * </p>
 * <p>
 * This class is used by the Maverick {@link  DocumentViewFactory}.
 ...
 * {@link DispatchedViewFactory DispatchedView} that uses the
 * {@link javax.servlet.RequestDispatcher RequestDispatcher} to forward control
...
public abstract class DocumentView implements View
{
     ...
     * scope and invokes the {@link #forward} View to complete the response.
     * </p>
     ...
     * </p>
     * <p>
     * The {@link DocumentViewFactory} provides an implementation of this
