...
/**
 * <p>
 * Factory for creating transformation pipelines based on executing successive documents
 * which are aware of servlet attribute collections. The output of the preceeding step is
 * stored as a String in the request attributes, available to be included anywhere in the
 * successive document.
 * </p>
 * 
 * <p>
 ...
 * <ul>
 * <li>
 * <b>default-bean-name</b> - If no "bean" attribute is specified for individual
 * transformations, this is the name which will be used for placing the wrapped content in
 * the request attributes.</li>
 * </ul>
 * 
 * <p>
...
public class DocumentTransformFactory implements TransformFactory
{
	...
	/**
	 * Unless overriden on path nodes, the bean name to use for wrapping content from
	 * previous stages.
	 */
	...
	public Transform createTransform(Element transformNode) throws ConfigException
	{
		...
		if (path == null)
			throw new ConfigException("Document transform node must have a \"" + ATTR_PATH
