...
/**
 * FormBeanUser is a base class for singleton controllers which use external FormBeans
 * rather than populating themselves. Since only one of these will exist for each command
 * definition, it must be thread-safe. This Controller pattern is very similar to Struts
 * Actions.
 */
public abstract class FormBeanUser implements ControllerSingleton
{
	...
	/**
	 * If you want any custom behavior based on the content of the configuration file,
	 * this will be called once before the FormBeanUser is ever used.
	 * 
	...
	/**
	 * Executes this controller. Override one of the other perform() methods to provide
	 * application logic.
	 * 
