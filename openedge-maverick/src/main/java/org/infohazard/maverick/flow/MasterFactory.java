...
class MasterFactory
{
	...
	/**
	 * xml attribute for the transform type name (for a view node), value =
	 * 'transform-type'
	 */
	...
	/**
	 * Reference to servlet config of Dispatcher servlet; needed to initialize View and
	 * Transform factories.
	 */
	...
	/**
	 * Defines a view factory for the specified type; Can be used to override a previously
	 * set factory.
	 * 
	 * @param typeName
	...
	/**
	 * Sets the default type to use if one is not explicitly defined in the transform
	 * node.
	 * 
	 * @param type
	...
	/**
	 * Defines a transform factory for the specified type. Can be used to override a
