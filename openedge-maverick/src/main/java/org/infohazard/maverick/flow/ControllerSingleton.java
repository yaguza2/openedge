 ...
 * a fresh instance for every request.  Second, it provides a method
 * to initialize the singleton controller with the relevant XML data
...
public interface ControllerSingleton extends Controller
{
	 ...
	 * @param controllerNode the xml node of this controller.
	 */
