...
public final class JettyHelper
{
     ...
     * @param useJettyPlus Whether to use JettyPlus; if true, org.mortbay.jetty.plus.Server will
     ...
     * @param port port to listener
     * @param webappContextRoot (possibly relative) path to use as webapp context root
     * @param contextPath webapp context path
     * @param useJettyPlus whether to use JettyPlus
     * @throws Exception
     */
    public static Server getJettyServerInstance(
            int port,
     ...
     * @param port port to listen to http requests
     * @param webappContextRoot the web application context root
     * @param contextPath the context path (webapp name)
     * @param useJettyPlus whether to use JettyPlus
     * @return Server started instance of Jetty server
     * @throws Exception
     */
    public static Server startJetty(
            int port, String webappContextRoot, String contextPath, boolean useJettyPlus)
    		throws Exception
    {
        log.info("Starting Jetty with arguments {port == " + port
            + ", webappContextRoot == " + webappContextRoot + ", contextPath == "
            + contextPath + "}");
        Server server = getJettyServerInstance(
     ...
     * @param jettyConfig the url to the configuration file (can be a classpath location)
     * @param useJettyPlus whether to use JettyPlus
     * @throws Exception
     */
    public static Server startJetty(
            String jettyConfig, boolean useJettyPlus)
    		throws Exception
    {
     ...
     * @param monitorPort port admin monitor
     * @param maxTries maximum number of tries
     * @param sleepBetweenTries miliseconds to pause between tries
     ...
     * @param commKey auth key
     * @param host host of monitor
     * @param monitorPort port of monitor
     * @throws Exception when issue of command failed
     */
